...
const ExploreCarPage = () => {
  ...
  // Fetch cars when search or category filters change
  useEffect(() => {
          ...
          <div className="text-center py-20 border border-slate-100 shadow-sm rounded-2xl bg-white">
            <div className="max-w-md mx-auto px-4">
              ...
              <button
                ...
                className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl px-6 py-3 transition-colors"
              >
                Reset Filters
              </button>
            </div>
